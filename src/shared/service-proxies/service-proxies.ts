...
export class GetEmployeeForEditOutput implements IGetEmployeeForEditOutput {
    ...
    init(_data?: any) {
        if (_data) {
            this.Employee = _data["Employee"] ? EmployeeEditDto.fromJS(_data["Employee"]) : <any>undefined;
        }
    }
...
export class EmployeeServiceProxy {
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Employee/DeleteMsEmployee?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<EmployeeDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetAllMsEmployeeList?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
     ...
     * @return Success
     */
    getById(id: number | undefined): Observable<GetEmployeeForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
   ...
   * @return Success
   */
    getEmployee(): Observable<EmployeeDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetAllMsEmployeeList";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEmployee(response: HttpResponseBase): Observable<EmployeeDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
